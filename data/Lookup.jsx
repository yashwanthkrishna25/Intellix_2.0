...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Intellix AI 2.0',
  SIGNIN_SUBHEADING: 'To use Intellix you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Intellix, you agree to the collection of usage data for analytics.',
